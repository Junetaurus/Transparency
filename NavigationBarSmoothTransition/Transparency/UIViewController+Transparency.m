//
//  UIViewController+Transparency.m
...
@implementation UIViewController (Transparency)

//定义常量 必须是C语言字符串
static char *TransparencyKey = "TransparencyKey";
...
- (void)setNavBarBgAlpha:(NSString *)navBarBgAlpha {
    ...
    objc_setAssociatedObject(self, TransparencyKey, navBarBgAlpha, OBJC_ASSOCIATION_COPY_NONATOMIC);
...
- (NSString *)navBarBgAlpha {
    return objc_getAssociatedObject(self, TransparencyKey);
}
